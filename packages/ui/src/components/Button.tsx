    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            // Variants
            'bg-blue-600 text-white hover:bg-blue-700 shadow-md shadow-blue-500/10 focus:ring-blue-500 dark:bg-blue-500 dark:hover:bg-blue-600 dark:shadow-none dark:focus:ring-offset-slate-950': variant === 'primary',
