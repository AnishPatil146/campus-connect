    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            // Variants
            'bg-blue-600 text-white hover:bg-blue-700 shadow-md shadow-blue-500/10 focus:ring-blue-500': variant === 'primary',
            'bg-slate-100 text-slate-900 hover:bg-slate-200 focus:ring-slate-400': variant === 'secondary',
            'border border-slate-200 bg-transparent hover:bg-slate-50 text-slate-700 focus:ring-slate-400': variant === 'outline',
            'bg-red-600 text-white hover:bg-red-700 shadow-md shadow-red-500/10 focus:ring-red-500': variant === 'danger',
            'bg-transparent hover:bg-slate-50 text-slate-600': variant === 'ghost',
